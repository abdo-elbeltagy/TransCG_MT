...
class Inferencer(object):
    ...
    Inferencer.
    """
    def __init__(self, cfg_path = os.path.join('configs', 'inference_SwinDRNet.yaml'), with_info = False, **kwargs):
        """
        Initialization.
    ...
    def inference(self, rgb, depth, target_size = (1280, 720), depth_coefficient = 10.0, inpainting = True):
        ...
        with torch.no_grad():
            ...
            depth_res, _, _, _ = self.model(rgb, depth)
            depth_res = depth_res.squeeze()
